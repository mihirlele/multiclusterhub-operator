...
func (in *MultiClusterHubStatus) DeepCopyInto(out *MultiClusterHubStatus) {
	*out = *in
	...
	if in.UninstallEscalation != nil {
		in, out := &in.UninstallEscalation, &out.UninstallEscalation
		*out = new(UninstallEscalationStatus)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *UninstallEscalationStatus) DeepCopyInto(out *UninstallEscalationStatus) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new UninstallEscalationStatus.
func (in *UninstallEscalationStatus) DeepCopy() *UninstallEscalationStatus {
	if in == nil {
		return nil
	}
	out := new(UninstallEscalationStatus)
